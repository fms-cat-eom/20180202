...
module.exports={default:require("core-js/library/fn/math/log10"),__esModule:!0};

},{"core-js/library/fn/math/log10":6}],3:[function(require,module,exports){
module.exports={default:require("core-js/library/fn/math/sign"),__esModule:!0};
...
},{"../../modules/_core":13,"../../modules/es6.math.log10":42}],7:[function(require,module,exports){
require("../../modules/es6.math.sign"),module.exports=require("../../modules/_core").Math.sign;

},{"../../modules/_core":13,"../../modules/es6.math.sign":43}],8:[function(require,module,exports){
...
},{"./_to-absolute-index":35,"./_to-iobject":37,"./_to-length":38}],12:[function(require,module,exports){
...
},{"./_export":19}],43:[function(require,module,exports){
var $export=require("./_export");$export($export.S,"Math",{sign:require("./_math-sign")});

},{"./_export":19,"./_math-sign":27}],44:[function(require,module,exports){
...
},{"./interpolator":55}],52:[function(require,module,exports){
...
},{"./noise":57}],56:[function(require,module,exports){
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_compat=require("./compat"),_compat2=_interopRequireDefault(_compat),_param2=require("./param"),_param3=_interopRequireDefault(_param2);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var Vue=void 0,GUI=void 0;Vue=require("vue"),GUI=require("./gui.vue");var Automaton=function(e){var t={rev:20180130},a="object"===(void 0===e?"undefined":_typeof(e))?e:{},r=(0,_compat2.default)(a.data);t.time=0,t.deltaTime=0,t.isPlaying=!0,t.length=r.length,t.resolution=r.resolution,t.setLength=function(e){if(!isNaN(e)){for(var a in t.params){for(var r=t.params[a],n=r.nodes.length-1;0<n;n--){e<r.nodes[n].time&&r.nodes.splice(n,1)}r.nodes[r.nodes.length-1].time!==e&&r.addNode(e,0)}t.length=e}},t.params={},t.createParam=function(e){var a=new _param3.default(t);return Vue.set(t.params,e,a),a},t.deleteParam=function(e){Vue.delete(t.params,e)},t.getParamNames=function(){var e=[];for(var a in t.params)e.push(a);return e=e.sort()},t.countParams=function(){var e=0;for(var a in t.params)e++;return e};for(var n in r.params){t.createParam(n).load(r.params[n])}if(t.setLength(t.length),t.seek=function(e){var r=e-Math.floor(e/t.length)*t.length;t.update(r),"function"==typeof a.onseek&&a.onseek(r)},t.play=function(){t.isPlaying=!0,"function"==typeof a.onplay&&a.onplay()},t.pause=function(){t.isPlaying=!1,"function"==typeof a.onpause&&a.onpause()},a.gui){var o=document.createElement("div");a.gui.appendChild(o),t.vue=new Vue({el:o,data:{automaton:t},render:function(e){return e(GUI,{props:{automaton:this.automaton}})}}),t.guiParams="object"===_typeof(r.gui)?r.gui:{snap:{enable:!1,bpm:120,offset:0}}}return t.renderAll=function(){for(var e in t.params)t.params[e].render()},t.update=function(e){if(a.fps){if("number"!=typeof e&&"number"==typeof t.frame&&t.isPlaying||(t.frame=Math.floor((e||t.time)*a.fps)),t.time=t.frame/a.fps,t.deltaTime=1/a.fps,t.isPlaying){var r=Math.floor(t.length*a.fps);t.frame=(t.frame+1)%r}}else if(a.realtime){var n=+new Date;"number"!=typeof e&&t.rtDate&&t.isPlaying||(t.rtTime=e||t.time,t.rtDate=n);var o=t.rtTime+.001*(n-t.rtDate);t.time=o-Math.floor(o/t.length)*t.length,t.rtPrev||(t.rtPrev=n),t.deltaTime=.001*(n-t.rtPrev),t.rtPrev=n}else{var i=e-Math.floor(i/t.length)*t.length;i=i||t.time,t.deltaTime=i-t.time,t.time=i}},t.auto=function(e){var a=t.params[e];return a||(a=t.createParam(e)),a.used=!0,a.getValue()},t.bye=function(){t=null},t.save=function(){var e={rev:t.rev,length:t.length,resolution:t.resolution,params:{}};for(var a in t.params){var r=t.params[a];e.params[a]=r.nodes}return t.guiParams&&(e.gui=t.guiParams),e},t};module.exports=Automaton;

},{"./compat":49,"./gui.vue":50,"./param":58,"vue":47}],57:[function(require,module,exports){
...
},{"./xorshift":60}],58:[function(require,module,exports){
...
},{"./interpolator":55}],59:[function(require,module,exports){
...
},{"babel-runtime/core-js/math/log10":2,"babel-runtime/core-js/math/sign":3,"vue":47,"vue-hot-reload-api":46,"vueify/lib/insert-css":48}],60:[function(require,module,exports){
